        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="mb-3">
                        <label for="user-password" class="col-form-label lang"
                               data-translate="password">Password:</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary lang" data-bs-dismiss="modal" id="modal-btn-cancel"
                        data-translate="cancel">Cancel
                </button>
